...
namespace Teltonika.Codec.Devices
{
    public class Codec7
    {
        ...
        private AvlData DecodeAvlData()
        {
            ...
            // priority
            var priorityAndTimeStampBits = Convert.ToString(priorityAndTimestamp, 2).PadLeft(32, '0');
            var priority = (GhAvlDataPriority)Convert.ToInt16(priorityAndTimeStampBits.Substring(0, 2));
        ...
        private GpsElementExt DecodeGpsElement()
        {
            ...
            {
                var lat = BitConverters.EndianBitConverters.Int32ToSingle(_reader.ReadInt32());
                var lng = BitConverters.EndianBitConverters.Int32ToSingle(_reader.ReadInt32());
