...
namespace Teltonika.Codec.Devices
{
    public class Codec8E
    {
        ...
        public Codec8E(ReverseBinaryReader reader)
        {
            if (reader == null)
            {
        ...
        private AvlData DecodeAvlData()
        {
            ...
            // IO Element decoding
            var eventId = _reader.ReadInt16();
            var propertiesCount = _reader.ReadInt16();
        ...
        private IEnumerable<IoProperty> DecodeIoProperties()
        {
            var result = new List<IoProperty>();

            // total number of I/O properties which length is 1 byte
            int ioCountInt8 = _reader.ReadInt16();
            for (var i = 0; i < ioCountInt8; i++)
            {
                var propertyId = (int)_reader.ReadInt16();
            ...
            int ioCountInt16 = _reader.ReadInt16();
            ...
            int ioCountInt32 = _reader.ReadInt16();
            ...
            int ioCountInt64 = _reader.ReadInt16();
            ...
            int ioCountX = _reader.ReadInt16();
            for (var i = 0; i < ioCountX; i++)
            {
                var propertyId = (int)_reader.ReadInt16();
                var elementLength = (int)_reader.ReadInt16();
                var value = _reader.ReadBytes(elementLength);
