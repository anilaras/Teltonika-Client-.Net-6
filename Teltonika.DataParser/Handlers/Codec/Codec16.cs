...
namespace Teltonika.DataParser.Client.Handlers.Codec
{
    public class Codec16 : AVLCodec
    {
        public override CompositeData GetAvlData(DataReader codecReader)
        {
            ...
            ioElementComposite.Add(codecReader.ReadData(2, DataType.EventIoIdCodec16));
            ioElementComposite.Add(codecReader.ReadData(1, DataType.OriginType));
            ...
            {
                ioElementComposite.Add(codecReader.ReadData(2, DataType.IoId1BCodec16));
            ...
            {
                ioElementComposite.Add(codecReader.ReadData(2, DataType.IoId2BCodec16));
            ...
            {
                ioElementComposite.Add(codecReader.ReadData(2, DataType.IoId4BCodec16));
            ...
            {
                ioElementComposite.Add(codecReader.ReadData(2, DataType.IoId8BCodec16));
